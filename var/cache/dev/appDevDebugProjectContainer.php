...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'pcc_apigator.apigator' => 'getPccApigator_ApigatorService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('94NLBkRNxJ', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('60owM+YheF', 0, '0apozhnFXVJnjIjoLMlOsK', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8771d69bcf5fbedfbffc680ad9b9bf571ef16f13c8d691348b35cd03a80e6acc');
    ...
    /**
     * Gets the 'pcc_apigator.apigator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pcc\ApigatorBundle\ApiGator A pcc\ApigatorBundle\ApiGator instance
     */
    protected function getPccApigator_ApigatorService()
    {
        return $this->services['pcc_apigator.apigator'] = new \pcc\ApigatorBundle\ApiGator();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/pcc/ApigatorBundle/Resources/views'), 'pccApigator');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('34483c5f279f1ea2d49811d8559aea251101e720');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AhpIP9s69B', 0, '0apozhnFXVJnjIjoLMlOsK', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59287c89dce603.12915951')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'pccApigatorBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/pcc/ApigatorBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'pccApigatorBundle' => 'pcc\\ApigatorBundle\\pccApigatorBundle',
            ...
            'secret' => '34483c5f279f1ea2d49811d8559aea251101e720',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '34483c5f279f1ea2d49811d8559aea251101e720',
