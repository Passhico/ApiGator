...
class AddClassesToCachePassTest extends TestCase
{
    public function testExpandClasses()
    {
        ...
        $this->assertSame(
            'Acme\\FooBundle\\Controller\\testController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\FooBundle\\Controller\\testController'))[0]
        );

        $this->assertSame(
            'FooBundle\\Controller\\testController',
            $expand(array('**Bundle\\Controller\\'), array('\\FooBundle\\Controller\\testController'))[0]
        );

        $this->assertSame(
            'Acme\\FooBundle\\Controller\\Bar\\testController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\FooBundle\\Controller\\Bar\\testController'))[0]
        );

        $this->assertSame(
            'Bundle\\Controller\\Bar\\testController',
            $expand(array('**Bundle\\Controller\\'), array('\\Bundle\\Controller\\Bar\\testController'))[0]
        );

        $this->assertSame(
            'Acme\\Bundle\\Controller\\Bar\\testController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\Bundle\\Controller\\Bar\\testController'))[0]
        );
